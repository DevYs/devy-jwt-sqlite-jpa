...
public class JwtSqliteJpaApplication implements CommandLineRunner {

	private static final Logger logger = LoggerFactory.getLogger(JwtSqliteJpaApplication.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(JwtSqliteJpaApplication.class, args);
	}
